...
class calculator:
    ...
    def create_specials_button(self):
    ...
    def create_display_labels(self):
        total_label = tk.Label(self.display_frame, text=self.total_expressions, anchor=tk.E,bg=LIGHT_GRAY,fg=LABEL_COLOR,padx=24, font=SMALL_FONT_STYLE)
        total_label.pack(expand=True,fill="both")
        label = tk.Label(self.display_frame, text=self.current_expressions, anchor=tk.E, bg=LIGHT_GRAY,fg=LABEL_COLOR, padx=24, font=LARGE_FONT_STYLE)
